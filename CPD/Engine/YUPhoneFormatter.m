...
- (NSString *)stringForObjectValue:(id)aObject {
    ...
    NSString *strFromatExampleTrimmed = @"_________";
    ...
    if (trimmedString.length>1&&trimmedString.length<=1) {
        [oStrFormatted appendFormat:@"%@%@",[trimmedString substringWithRange:NSMakeRange(0, 1)],prefix11];
